...
// Root backend URL — VITE_API_BASE_URL must NOT include /api/v1
const BACKEND_BASE = import.meta.env.VITE_API_BASE_URL || import.meta.env.VITE_API_BASE?.replace('/api/v1', '') || 'http://127.0.0.1:8000'
